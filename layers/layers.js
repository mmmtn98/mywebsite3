...
var lyr_pl_amphoe_2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'pl_amphoe<br />\
    <img src="styles/legend/pl_amphoe_2_0.png" /> 353765464.468<br />\
    <img src="styles/legend/pl_amphoe_2_1.png" /> 716223001.021<br />\
    <img src="styles/legend/pl_amphoe_2_2.png" /> 831560208.993<br />\
    <img src="styles/legend/pl_amphoe_2_3.png" /> 886915615.265<br />\
    <img src="styles/legend/pl_amphoe_2_4.png" /> 969109772.817<br />\
    <img src="styles/legend/pl_amphoe_2_5.png" /> 1109986328.428<br />\
    <img src="styles/legend/pl_amphoe_2_6.png" /> 1652689635.137<br />\
    <img src="styles/legend/pl_amphoe_2_7.png" /> 1714369693.080<br />\
    <img src="styles/legend/pl_amphoe_2_8.png" /> 2361969772.509<br />'
        });
...
var format_pl_transportation_5 = new ol.format.GeoJSON();
var features_pl_transportation_5 = format_pl_transportation_5.readFeatures(json_pl_transportation_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_pl_transportation_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_pl_transportation_5.addFeatures(features_pl_transportation_5);
var lyr_pl_transportation_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_pl_transportation_5, 
                style: style_pl_transportation_5,
                interactive: true,
                title: '<img src="styles/legend/pl_transportation_5.png" /> pl_transportation'
            });
...
jsonSource_pl_village_6.addFeatures(features_pl_village_6);
...
lyr_StamenTonerLite_0.setVisible(true);lyr_OSMStandard_1.setVisible(true);lyr_pl_amphoe_2.setVisible(true);lyr_pl_tambon_3.setVisible(true);lyr_pl_stream_4.setVisible(true);lyr_pl_transportation_5.setVisible(true);lyr_pl_village_6.setVisible(true);
var layersList = [lyr_StamenTonerLite_0,lyr_OSMStandard_1,lyr_pl_amphoe_2,lyr_pl_tambon_3,lyr_pl_stream_4,lyr_pl_transportation_5,lyr_pl_village_6];
...
lyr_pl_transportation_5.set('fieldAliases', {'LENGTH': 'LENGTH', 'TRANS_TYP': 'TRANS_TYP', 'TYP_T': 'TYP_T', 'NAME_T': 'NAME_T', 'NAME_E': 'NAME_E', 'TranNo': 'TranNo', 'TranTyp_n': 'TranTyp_n', });
...
lyr_pl_transportation_5.set('fieldImages', {'LENGTH': 'TextEdit', 'TRANS_TYP': 'TextEdit', 'TYP_T': 'TextEdit', 'NAME_T': 'TextEdit', 'NAME_E': 'TextEdit', 'TranNo': 'Range', 'TranTyp_n': 'Range', });
...
lyr_pl_transportation_5.set('fieldLabels', {'LENGTH': 'no label', 'TRANS_TYP': 'no label', 'TYP_T': 'no label', 'NAME_T': 'no label', 'NAME_E': 'no label', 'TranNo': 'no label', 'TranTyp_n': 'no label', });
